...
-- 채팅 세션 초기 데이터
INSERT INTO chat_sessions (user_id, title, created_at, updated_at, is_deleted) VALUES
('user@example.com', '첫 번째 대화', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, false),
('user@example.com', '두 번째 대화', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, false);
