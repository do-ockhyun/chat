...
//         ChatSession session = new ChatSession(empNo, title);
//         given(chatDataService.createSession(empNo, title)).willReturn(session);

//         // when
//         ChatSessionResponse response = chatService.createSession(empNo, title);
...
//         ChatSession session = new ChatSession("EMP001", "Test Chat");
